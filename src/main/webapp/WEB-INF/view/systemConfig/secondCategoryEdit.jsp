...
<div class="main">
    ...
    <div class="bread detail-bread">
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/fabricFirstCategory">面料二级分类维护</a></li>
            <li>新增面料二级分类</li>
        </ul>
    </div>
    <!-- /.Detail Bread -->
    <div class="center publish-info">
        <form:form modelAttribute="secondCategory" action="${pageContext.request.contextPath}/admin/fabricSecondCategory/add" method="post">
