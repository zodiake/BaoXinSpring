...
<div class="container">
    <!--title-->
    <div class="modebox">
        <div class="hd"><a href="${pageContext.request.contextPath}/notice">公告</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/info">资讯</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/masterView">专家访谈</a>&nbsp;|&nbsp;<strong><a href="${pageContext.request.contextPath}/topic1022" style="font-size: 14px;">云端时尚跨界峰会</a></strong>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/topic">云端时尚对接会</a></div>
    </div>
    <!--title-->
    <!--左边-->
            ...
            <div class="con information-mode">
                        ...
                        <c:forEach items="${grid.ecList}" var="topic">
                            <li>
                                <span class="text-content">
                                    ...
                                    <h6><a href="${pageContext.request.contextPath}/topic1022/${topic.id}" title="">${topic.title} </a></h6>
                                    <p <c:if test="${not empty topic.viewPath}">class="txt"</c:if>>
                                        <a href="${pageContext.request.contextPath}/topic1022/${topic.id}" title="">${topic.briefContent}</a>
                                    </p>
                ...
                <div class="text-right">
                    <c:if test="${grid.totalPages>1}">
                        ...
                        <%--</ul>--%>
                        <sbTag:page total="${grid.totalPages}" current="${grid.currentPage}" href="${pageContext.request.contextPath}/topic?1=1"></sbTag:page>
                    </c:if>
                </div>
                <!--翻页 end-->
            </div>
