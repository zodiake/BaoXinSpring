        ...
        <div class="main">
            <div class="con information-details">
                ...
                <c:if test="${not empty information.videoPath}">
                    <IFRAME src="${information.videoPath}" frameBorder=0 scrolling="no" width="100%" height="600px" style="position:relative;left:0;bottom:0" marginheight="0" allowfullscreen></IFRAME>
                </c:if>
            </div>
            <div>
            </div>
