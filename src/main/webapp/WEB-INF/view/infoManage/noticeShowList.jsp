...
<div class="container">
    <!--title-->
    <div class="modebox">
        <div class="hd"><strong><a href="${pageContext.request.contextPath}/notice" style="font-size: 14px;">公告</a></strong>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/info">资讯</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/masterView">专家访谈</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/topic1022">云端时尚跨界峰会</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/topic">云端时尚对接会</a></div>
    </div>
    <!--title-->
    <!--左边-->
            ...
            <div class="con information-mode">
                    ...
                    <ul>
                        <c:forEach items="${grid.ecList}" var="notice">
                            <li>
                                ...
                                <p <c:if test="${not empty notice.viewPath}">class="txt"</c:if>><a href="${pageContext.request.contextPath}/notice/${notice.id}" title="">${notice.briefContent}</a></p>
                ...
                <div class="text-right">
                    <c:if test="${grid.totalPages>1}">
                        ...
                        <%--</ul>--%>
                        <sbTag:page total="${grid.totalPages}" current="${grid.currentPage}" href="${pageContext.request.contextPath}/notice?1=1"></sbTag:page>
                    </c:if>
                </div>
                <!--翻页 end-->
            </div>
