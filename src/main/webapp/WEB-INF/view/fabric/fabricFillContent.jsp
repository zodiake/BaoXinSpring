            ...
            <li>
                ...
                <div>
                    <ul>
                        ...
                        <li>
                            <label>克重：</label>
                            <form:input path="fakeHeight"></form:input>
                            <p class="gray">g/m²</p>
                            <form:errors path="fakeHeight" cssClass="error"></form:errors>
                        </li>
                        <li>
                            <label>染整工艺：</label>
                        ...
                        <li class="publish">
                            <label class="pattern" title="请选择图案">图案：<img src="${pageContext.request.contextPath}/resources/images/PocketAdd.png" style="height: 25px;width: 25px;float: right"></label>
