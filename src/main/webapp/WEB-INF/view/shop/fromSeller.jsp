        ...
        <td colspan="4">
            <div class="text-right" id="fromSellerPage">
                <c:if test="${grid.totalPages>0}">
                    ...
                    <sbTag:page total="${grid.totalPages}" current="${grid.currentPage}" href="${pageContext.request.contextPath}/sellerCenter/comments/${id}/fromSeller?1=1" dataUrl="${pageContext.request.contextPath}/sellerCenter/comments/${id}/fromSeller?1=1"></sbTag:page>
                </c:if>
            </div>
        </td>
    </tr>
