        ...
        <td colspan="4">
            <div class="text-right" id="fromSellerSendPage">
                <c:if test="${grid.totalPages>1}">
                    ...
                    <sbTag:page total="${grid.totalPages}" current="${grid.currentPage}" href="${pageContext.request.contextPath}/buyerCenter/${id}/sellerComments?1=1" dataUrl="${pageContext.request.contextPath}/buyerCenter/${id}/sellerComments?1=1"></sbTag:page>
                </c:if>
            </div>
        </td>
    </tr>
