 ...
 */
@Entity
@Table(name="t_ec_user_prefermaterialcategory")
public class FavouriteMaterialCategory implements Serializable{
    @Embeddable
    ...
    public FavouriteMaterialCategory(){}

    public FavouriteMaterialCategory(EcUser user,MaterialCategory category){
