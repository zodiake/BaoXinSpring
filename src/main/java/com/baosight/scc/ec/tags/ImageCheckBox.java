 ...
 */
public class ImageCheckBox extends AbstractMultiCheckedElementTag {
    private String src;
    ...
    protected int writeTagContent(TagWriter tagWriter) throws JspException {
        ...
        String rgbProperty =
                (src != null ? ObjectUtils.getDisplayString(evaluate("src", rgb)) : null);
        ...
        if (itemsObject.getClass().isArray()) {
            ...
            for (int i = 0; i < itemsArray.length; i++) {
                ...
                writeObjectEntry(tagWriter, valueProperty, labelProperty, item, i, rgbProperty);
            }
            ...
            for (Iterator it = optionCollection.iterator(); it.hasNext(); itemIndex++) {
                Object item = it.next();
                writeObjectEntry(tagWriter, valueProperty, labelProperty, item, itemIndex, rgbProperty);
            }
            ...
            for (Iterator it = optionMap.entrySet().iterator(); it.hasNext(); itemIndex++) {
                ...
                writeMapEntry(tagWriter, valueProperty, labelProperty, entry, itemIndex, rgbProperty);
            }
        } else {
    ...
    private void writeObjectEntry(TagWriter tagWriter, String valueProperty,
                                  String labelProperty, Object item, int itemIndex, String rgb) throws JspException {
        ...
        Object renderRgb = (rgb != null ? wrapper.getPropertyValue(rgb) : item);
        Object renderLabel = (labelProperty != null ? wrapper.getPropertyValue(labelProperty) : item);
        writeElementTag(tagWriter, item, renderValue, renderLabel, itemIndex, renderRgb);
    }

    private void writeElementTag(TagWriter tagWriter, Object item, Object value, Object label, int itemIndex, Object rgb) throws JspException {
        ...
        tagWriter.startTag("bdo");
        tagWriter.writeAttribute("style", "background:"+rgb);
    ...
    private void writeMapEntry(TagWriter tagWriter, String valueProperty,
                               String labelProperty, Map.Entry entry, int itemIndex, String rgb) throws JspException {
        ...
        writeElementTag(tagWriter, mapKey, renderValue, renderLabel, itemIndex, rgb);
    }
}
