...
<div class="container">
    <!--title-->
    <div class="modebox">
        <div class="hd"><a href="${pageContext.request.contextPath}/notice">公告</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/info">资讯</a>&nbsp;|&nbsp;<strong><a href="${pageContext.request.contextPath}/topic" style="font-size: 14px;">8•26专题</a></strong></div>
    </div>
    <!--title-->
    <!--左边-->
                        ...
                        <c:forEach items="${grid.ecList}" var="topic">
                            <li>
                                <span class="text-content">
                                    ...
                                    <h6><a href="${pageContext.request.contextPath}/topic/${topic.id}" title="">${topic.title} </a></h6>
                                    <p class="txt">
                                        <a href="${pageContext.request.contextPath}/topic/${topic.id}" title="">${topic.briefContent}</a>
                                    </p>
