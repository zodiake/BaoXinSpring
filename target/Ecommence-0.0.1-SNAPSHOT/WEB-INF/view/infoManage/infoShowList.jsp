...
<div class="container">
    <!--title-->
    <div class="modebox">
        <div class="hd"><a href="${pageContext.request.contextPath}/notice">公告</a>&nbsp;|&nbsp;<strong><a href="${pageContext.request.contextPath}/info" style="font-size: 14px;">资讯</a></strong>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/topic">8•26专题</a></div>
    </div>
    <!--title-->
    <!--左边-->
                    ...
                    <ul>
                        <c:forEach items="${grid.ecList}" var="info">
                            <li>
                                ...
                                <p class="txt infor-bg"><a href="${pageContext.request.contextPath}/info/${info.id}" title="">${info.briefContent}</a></p>
