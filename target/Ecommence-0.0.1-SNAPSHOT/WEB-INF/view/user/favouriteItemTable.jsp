            ...
            <ul>
                <c:forEach var="favouriteItem" items="${grid.ecList}">
                    ...
                    <li>
                        ...
                        <div class="price">&yen;${favouriteItem.item.price} (${favouriteItem.item.state})</div>
                        ...
                        <div class="bargain">
                            成交${favouriteItem.item.bidCount}笔<div class="bargain-fun"><a class="del-icon deleteFavouriteItem" data-id="${favouriteItem.item.id}" title="删除关注的商品"></a><a class="home-icon" href="/shopCenter/${favouriteItem.item.createdBy.id}/items" title="供应商主页"></a><a class="shopping-car-icon addCart"  data-id="${favouriteItem.item.id}" title="加入购物车"></a><a class="album-icon addBook"  data-id="${favouriteItem.item.id}" title="加入调样册"></a></div>
                        </div>
                    </li>
                </c:forEach>
            </ul>
