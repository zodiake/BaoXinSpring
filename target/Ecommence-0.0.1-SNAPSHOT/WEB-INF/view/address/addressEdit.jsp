    ...
    <div class="bread detail-bread">
        ...
        <div class="modebox security-deliver">
            <div class="con">
                ...
                <form:form modelAttribute="address" action="${pageContext.request.contextPath}/buyerCenter/address" method="post">
                    <div class="deliver-list">
                        <ul>
                            <li></li>
                            <li><span class="name"><em class="col-red">*</em>所在地区：</span>
                                <form:select path="state" class="select-t">
                                        <form:option value="${address.state}" >${address.state}</form:option>
                                </form:select>
                                <form:select path="city" class="select-t">
                                        <form:option value="${address.city}">${address.city}</form:option>
                                </form:select>
                                <div class="msg-error Hide"></div>
                            </li>
                            <li><div class="name"><em class="col-red">*</em>邮政编码：</div><form:input path="zipCode" class="input-t"></form:input><div class="msg-error Hide"><i class="error-icon"></i>请填写邮编！</div></li>
                            <li><div class="name"><em class="col-red">*</em>街道地址：</div><form:textarea path="street" class="tarea-t"></form:textarea><div class="msg-error Hide"><i class="error-icon"></i>请填写详细地址！</div></li>
                            <li><div class="name"><em class="col-red">*</em>收货人姓名：</div><form:input path="receiverName" class="input-t"></form:input><div class="msg-error Hide"><i class="error-icon"></i>2-20个字符，一个汉字为三个字符！</div></li>
                            ...
                            <li>
                                ...
                                <div class="approve-label">
                                    <label>
                                        <c:if test="${address.defaultAddress[0] ==0}">
                                            <form:checkbox path="defaultAddress" value=""></form:checkbox>
                                        </c:if>
                                        <c:if test="${address.defaultAddress[0] ==1}">
                                            <form:checkbox path="defaultAddress" value="1"></form:checkbox>
                                        </c:if>
                                        设置为默认收货地址
                                    </label>
                                </div>
