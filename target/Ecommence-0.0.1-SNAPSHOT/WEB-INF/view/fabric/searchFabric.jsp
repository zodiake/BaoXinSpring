...
<div class="search-result">
    <div class="search-result-panel">
        ...
        <ul class="list-inline inline-block">
            <li >
                <div class="inline-fame">
                    <input type="text" class="w-60 input-small" id="fakeMinPrice" name="fakeMinPrice" placeholder="最低价" value="${search.minPrice}">
                    ~
                    <input type="text" class="w-60 input-small" id="fakeMaxPrice" name="fakeMaxPrice" placeholder="最高价" value="${search.maxPrice}">
                </div>
                <div class="inline-pop">
                        ...
                        <tr>
                                ...
                                <a href="/fabric/${list.id}">
                                    <c:choose>
                                        <c:when test="${not empty list.cover}">
                                            <img class="thumb" src="${pageContext.request.contextPath}${list.cover}?size=300">
                                        </c:when>
                                        <c:otherwise>
                            ...
                            <td>
                                ...
                                <p class="gray">
                                    ...
                                    <span>克重：${list.weight}</span>|
                                    <span>季节：<c:forEach items="${list.seasons}" var="season">${season} </c:forEach></span>|
            ...
            <c:forEach items="${suggestion}" var="s">
                <div class="col-1">
                    ...
                    <ul>
                        ...
                        <li>
                            <label>销量：</label>
                            <span><bdo class="orange">${s.sales}</bdo>件</span>
                        </li>
                    </ul>
                </div>
            </c:forEach>
