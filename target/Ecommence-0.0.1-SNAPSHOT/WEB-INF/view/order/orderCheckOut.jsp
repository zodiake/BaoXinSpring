                ...
                <dd>
                    <table class="table table-border table-order">
                        ...
                        <c:forEach items="${cartLineList}" var="cartLine">
                            <c:if test="${cartLine.isCheck == 0}">
                                <tr class="dataTable_${cartLine.itemId}">
                                    <td><a href="${pageContext.request.contextPath}/${cartLine.itemType}/${cartLine.itemId}">${cartLine.title}</a></td>
                                    ...
                                    <td>
                                        ...
                                        <button class="button button-default immediatelyToCart" data-id="${cartLine.itemId}" data-spid="${sellerId}">加入购物车</button>
                                    </td>
                                    </c:if>
                                    <c:if test="${orderImmediately != 1}">
                                        <button class="button button-default reAddCart" data-id="${cartLine.itemId}" data-spid="${sellerId}" data-price="${cartLine.summary}">放回购物车</button></td>
                                    </c:if>
                                </tr>
                            </c:if>
                        </c:forEach>
                ...
                <div class="right">
                    ...
                    <form action="${pageContext.request.contextPath}/orderCenter/submitOrderImmediately" method="post" id="orderForm">
                        ...
                        <form action="${pageContext.request.contextPath}/orderCenter/submitOrder" method="post" id="orderForm">
                            ...
                            <p class="right"><input type="button" value="提交订单" class="button button-deep" name="_target1" onclick="preSubmit()"/></p>
                        </form>
                </div>
            </div>
            <!-- /.Cart Order-Info -->
