...
<div class="main">
    ...
    <div class="bread detail-bread">
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/firstSource">产品成分一级分类维护</a></li>
            <li>新增产品成分一级分类</li>
        </ul>
    </div>
    <!-- /.Detail Bread -->
    <div class="center publish-info">
        <form:form modelAttribute="firstCategory" action="${pageContext.request.contextPath}/admin/firstSource/add" method="post">
            <div align="left" style="border: 1px solid cornsilk">
                <ul>
                    <li><span class="name">产品成分：</span><form:input path="name"></form:input></li>
