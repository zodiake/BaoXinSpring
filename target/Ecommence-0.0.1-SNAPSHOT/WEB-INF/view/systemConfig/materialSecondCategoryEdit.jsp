...
<div class="main">
    ...
    <div class="bread detail-bread">
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/materialFirstCategory">产品成分二级分类维护</a></li>
            <li>新增产品成分二级分类</li>
        </ul>
    </div>
    <!-- /.Detail Bread -->
    <div class="center publish-info">
        <form:form modelAttribute="secondCategory" action="${pageContext.request.contextPath}/admin/materialSecondCategory/add" method="post">
            <div align="left" style="border: 1px solid cornsilk">
                <ul>
                    <li>
                        <span class="name">一级分类：</span>
