...
<form:form method="post" modelAttribute="demandOrder" id="form">
        ...
        <dd>
                <ul>
                    ...
                    <li>
                        ...
                        <input type="checkbox" class="checkbox" name="provideType" value="现货">现货　
                        <input type="checkbox" class="checkbox" name="provideType" value="期货">期货　
                        <input type="checkbox" class="checkbox" name="provideType" value="可调货">可调货　
                    ...
                    <li>
                        ...
                        <p class="gray modifyUnit">米</p>
                    </li>
                    <li>
                        <label><i class="red">*</i>备注：</label>
